...
namespace MonikAI
{
    ...
    public partial class SettingsWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            this.checkBoxMirrored.IsChecked = MonikaiSettings.Default.Mirrored;
            ...
            this.comboBoxPose.SelectedItem = MonikaiSettings.Default.Pose;
        ...
        private void Window_Closing(object sender, CancelEventArgs e)
        {
            ...
            MonikaiSettings.Default.Pose = (string)this.comboBoxPose.SelectedItem;
            MonikaiSettings.Default.Mirrored = this.checkBoxMirrored.IsChecked.GetValueOrDefault(false);
        ...
        private void comboBoxPose_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            MonikaiSettings.Default.Pose = (string)this.comboBoxPose.SelectedItem;
            this.mainWindow.SetMonikaFace("a");
        }
